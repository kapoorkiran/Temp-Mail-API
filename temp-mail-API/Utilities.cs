...
public static class Utilities
{
    ...
    public static IEnumerable<HtmlNode> GetElementsByClassName(HtmlDocument document, string className)
    {
        return document.DocumentNode.Descendants().Where(n => n.GetAttributeValue("class", null) == className).ToList();
    }
}
